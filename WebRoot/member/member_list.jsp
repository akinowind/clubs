...
<div class="pageContent">
	...
	<s:if test="#session.userlevel==1">
		<ul class="toolBar">
			<li><a class="add" href="member/member_update?m.student_id=201" target="dialog" mask="true"><span>添加</span></a></li>
	...
	<table class="table" width="100%" layoutH="138" align="center">
		<thead>
			<tr  style="text-align:center" >
				...
				<th width="150" orderField="student_id" <s:if test="orderField=='student_id'">class="${orderDirection}"</s:if>>学号</th>
				<th width="80" >姓名</th>
				<th width="100">社团</th>
				<th width="100">职位</th>
		...
		<s:iterator value="members" var="m">
			<tr target="student_id" rel="<s:property value="#m.student_id"/>">
				...
				<td align=center >22<s:property value="#m.student_id"/></td>
				<td align=center ><s:property value="#m.member_name"/></td>
				<td align=center ><s:property value="#m.c_name"/></td>
				<td align=center ><s:if test="#m.c_m_job==1">主席</s:if><s:elseif test="#m.c_m_job==0">主席</s:elseif><s:elseif test="#m.c_m_job==2">副主席</s:elseif><s:elseif test="#m.c_m_job==3">部长</s:elseif><s:elseif test="#m.c_m_job==4">副部长</s:elseif><s:elseif test="#m.c_m_job==5">会员</s:elseif><s:else>未知职位</s:else></td>
				<td align=center ><s:property value="#m.member_phone"/></td>
				<td align=center ><s:property value="#m.member_email"/></td>
				<td align=center ><s:property value="#m.member_qq"/></td>
				<td align=center ><s:property value="#m.member_college"/></td>
				<td align=center ><s:property value="#m.member_class"/></td>
				<td align=center >
				<s:if test="#session.userlevel==1">
					...
					<a  title="查看记录"  target="dialog" mask="true" rel="showrecord" target="dialog" href="member/member_showrecord?m.c_m_id=<s:property value="#m.c_m_id"/>">
				...
				<td align=center ><s:if test="#m.member_statue==0">未注册</s:if><s:elseif test="#m.member_statue==1">已注册</s:elseif></td>
			</tr>
		</s:iterator>
